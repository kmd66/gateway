...
using WebConfig = System.Web.Configuration.WebConfigurationManager;
	...
	{
		public ApiManagementApiClient(Kama.AppCore.IObjectSerializer objectSerializer): base(objectSerializer)
		{
			 _objectSerializer = objectSerializer;
		}

		 public override string Host 
			 => WebConfig.AppSettings["ApiManagementHost"];
...
namespace Kama.ApiManagement.ApiClient
{
	...
	partial class IssuedTokenService : IIssuedTokenService
	{
	...
	partial class QrService : IQrService
	{
	...
	partial class QueueService : IQueueService
	{
	...
	partial class SsoService : ISsoService
	{
	...
	partial class TokenService : ITokenService
	{
